...
4. Írd ki az elemzést a `bible_import/verse-analysis/{usx_code}_{chapter}.json` fájlba, UTF-8 kódolással, olvasható (nem escape-elt) görög szöveggel, 2 szóköz behúzással.
